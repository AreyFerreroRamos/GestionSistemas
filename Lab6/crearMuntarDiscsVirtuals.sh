...
# Descripció: Es creen dos discs virtuals a memòria. El primer disc tindrà una mida de 100 MB, es muntarà al directori /usuari/home/Baixades cada vegada que l'usuari al que pertanyi entri en el sistema i 
#		s'esborrarà quan l'usuari surti del sistema. Això implica que n'hi haurà un per cada usuari connectat. El segon disc tindrà format tmpfs es muntarà a /mnt/mem cada vegada que s'engegui la màquina
#		i hi podran llegir i  escriure tots els usuaris del sistema.
#	Paràmetres:
#		-
#	Retorn:
#		-
